// Josephites Global Multi-Device Realtime Cloud Engine v3.7
  ...
  return [
    {
      ...
      content: "✨ Welcome to **Josephites**! Connect with fellow Josephites in real-time. (Tip: Hold any message to edit, delete, or react).",
...
// ========================================================
// TOUCH-AND-HOLD (LONG PRESS) ACTION SHEET CONTROLLER
// ========================================================
function openActionSheet(msgId) {
  ...
  const isSender = msg.senderId === myUserId || msg.senderName === currentUserName;
  const isAdmin = userRole === 'ADMIN';
  ...
  // Configure Edit Button (Only Sender & Within 5 mins & Text message)
  const canEdit = isSender && isWithin5Min && msg.type === 'TEXT';
...
// Long-Press Event Binder for Mobile & Desktop
...
// ========================================================
// MESSAGE EDIT & DELETE ACTIONS (5-MIN WINDOW & ADMIN MODERATION)
// ========================================================
function editMessage(msgId) {
  ...
  const updatedContent = prompt("Edit your message:", msg.content);
...
function appendMessage(msg, scroll = true) {
  ...
  row.innerHTML = `
    ...
    <div class="message-bubble" id="bubble-${msg.id}" title="Hold to Edit, Delete or React">
